...
GLuint TextureHelper::load2DTexture(const char* filename, GLint internalFormat,
...
/*使用2D纹理，若输入为0则取消使用纹理
*/
void TextureHelper::use2DTexture(GLuint textureId) {
	glBindTexture(GL_TEXTURE_2D, textureId);
}

GLuint TextureHelper::loadDDS(const char * filename) {
